 ...
 *
 */
#ifndef AI_NR_SL_UE_MAC_SCHEDULER_SIMPLE_H
#define AI_NR_SL_UE_MAC_SCHEDULER_SIMPLE_H
 ...
 */
class AiNrSlUeMacSchedulerSimple : public NrSlUeMacSchedulerNs3
{
public:
  /**
   * \brief GetTypeId
   ...
   */
  AiNrSlUeMacSchedulerSimple ();

  ~AiNrSlUeMacSchedulerSimple() override;
